...
def download_database(
    ...
    output_dir : str, optional
        Output directory for downloaded files. If None, uses default location
        (~/.turbo_genius_tmp/), by default None.
    ...
    Notes
    -----
    The downloaded files are stored in the specified output directory or
    the default location. A "completed" marker file is created after
    successful download.
    """
...
def main():
    ...
    Sets up argument parsing, configures logging, and calls download_database()
